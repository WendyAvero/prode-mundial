    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <aside className="hidden lg:flex flex-col fixed inset-y-0 w-64 bg-slate-800 border-r border-slate-700 z-30">
        ...
        <nav className="flex-1 px-3 py-4 space-y-1">
          ...
          <Link href="/pronosticos" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:bg-slate-700 hover:text-white transition-colors text-sm">🎯 Pronósticos</Link>
        ...
        <div className="px-3 pb-6 border-t border-slate-700 pt-3">
          <Link href="/login" className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-slate-400 hover:text-red-400 hover:bg-slate-700 transition-colors text-sm">🚪 Cerrar sesión</Link>
        </div>
      </aside>
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 bg-slate-800 border-t border-slate-700 z-40">
        <div className="flex items-center justify-around py-2">
          ...
          <Link href="/pronosticos" className="flex flex-col items-center px-3 py-1 text-slate-400 text-xs">🎯<span>Pronós.</span></Link>
